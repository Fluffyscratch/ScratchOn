...
otherwise exploit the bot or its assets without permission. The only exception is when forking with the only goal being to contribute to the bot - not create a new bot based on this repository, or otherwise exploit our files for purposes other than direct contribution.
